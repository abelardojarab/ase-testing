...
DUT_INCDIR = $(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/include_files+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/include_files/common+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs/RAM+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs/RAM/lpbk1_RdRspRAM2PORT+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs/RAM/lpbk1_RdRspRAM2PORT/ram_2port_151+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs/RAM/lpbk1_RdRspRAM2PORT/ram_2port_151/synth+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs/RAM/lpbk1_RdRspRAM2PORT/synth+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs/RAM/req_C1TxRAM2PORT+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs/RAM/req_C1TxRAM2PORT/ram_2port_151+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs/RAM/req_C1TxRAM2PORT/ram_2port_151/synth+$(ASEVAL_GIT)/test_afus/ccip_vtp_nlb/HW/QSYS_IPs/RAM/req_C1TxRAM2PORT/synth+$(BBB_GIT)/cci_mpf/HW/+$(BBB_GIT)/cci_mpf/HW/cci-mpf-shims+$(BBB_GIT)/cci_mpf/HW/cci-mpf-shims/cci_mpf_shim_vtp+$(BBB_GIT)/cci_mpf/HW/cci-mpf-shims/cci_mpf_shim_edge+$(BBB_GIT)/cci_mpf/HW/cci-if+$(BBB_GIT)/cci_mpf/HW/cci-mpf-if+$(BBB_GIT)/cci_mpf/HW/par+$(BBB_GIT)/cci_mpf/HW/cci-mpf-prims+$(BBB_GIT)/cci_mpf/test_afus/+
