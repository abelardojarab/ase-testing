...
#define AFU_ID_H                 BASE_OFFSET + 0x010
#define CSR_DFH_RSVD0            BASE_OFFSET + 0x018
#define CSR_DFH_RSVD1            BASE_OFFSET + 0x020

#define CSR_SCRATCHPAD0          BASE_OFFSET + 0x100
#define CSR_SCRATCHPAD1          BASE_OFFSET + 0x104
#define CSR_SCRATCHPAD2          BASE_OFFSET + 0x108

#define CSR_AFU_DSM_BASEL        BASE_OFFSET + 0x110
#define CSR_AFU_DSM_BASEH        BASE_OFFSET + 0x114
#define CSR_SRC_ADDR             BASE_OFFSET + 0x120
#define CSR_DST_ADDR             BASE_OFFSET + 0x128
#define CSR_NUM_LINES            BASE_OFFSET + 0x130
#define CSR_CTL                  BASE_OFFSET + 0x138
#define CSR_CFG                  BASE_OFFSET + 0x140
#define CSR_INACT_THRESH         BASE_OFFSET + 0x148
#define CSR_INTERRUPT0           BASE_OFFSET + 0x150
